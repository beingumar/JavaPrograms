...
public class CalculatorFrame  extends Frame{
	...
	public CalculatorFrame() {
		...
		mulButton.setBounds(220,120,80,30);
		add(mulButton);
		mulButton.addActionListener(new CalculatorHandler(this));
		
		Button divButton = new Button("Division");
		divButton.setBounds(320,120,80,30);
		add(divButton);
		divButton.addActionListener(new CalculatorHandler(this));
